	...
	return (
		<div className="w-max flex justify-center gap-2">
			{pages.map(value => (
				<span
					key={value}
					className={`${value + 1 === currentPage ? "bg-blue-600 pointer-events-none" : "bg-grayscale-400 cursor-pointer"} text-common-white rounded-circle font-medium w-8 h-8 flex items-center justify-center`}
